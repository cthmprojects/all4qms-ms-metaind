...
import { sampleWithRequiredData } from '../indicador.test-samples';
import { IndicadorService } from '../service/indicador.service';

import { IndicadorComponent } from './indicador.component';
import SpyInstance = jest.SpyInstance;

describe('Indicador Management Component', () => {
  let comp: IndicadorComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(IndicadorComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.indicadors?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to indicadorService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getIndicadorIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getIndicadorIdentifier).toHaveBeenCalledWith(entity);
