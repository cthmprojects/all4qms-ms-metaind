...
import { sampleWithRequiredData, sampleWithNewData } from '../meta.test-samples';
      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            medicao: expect.any(Object),
            acao: expect.any(Object),
            avaliacaoResultado: expect.any(Object),
            idProcesso: expect.any(Object),
            monitoramento: expect.any(Object),
            periodo: expect.any(Object),
            recursos: expect.any(Object),
            metaObjetivo: expect.any(Object),
          }),
        );
      });
