...
public class MetaRecursoService {
    ...
    private final Logger log = LoggerFactory.getLogger(MetaRecursoService.class);
    ...
    /**
     * Get all the metaRecursos.
     *
     * @param pageable the pagination information.
     * @return the list of entities.
     */
    @Transactional(readOnly = true)
    public Page<MetaRecursoDTO> findAll(Pageable pageable) {
        log.debug("Request to get all MetaRecursos");
        return metaRecursoRepository.findAll(pageable).map(metaRecursoMapper::toDto);
    }
    ...
    public Page<MetaRecursoDTO> findWithFiltro(String filtro, Pageable pageable) {
        return metaRecursoRepository.findByRecursoNomeLike(filtro, pageable).map(metaRecursoMapper::toDto);
    }
}
