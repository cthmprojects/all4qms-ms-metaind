...
public interface MetaMapper extends EntityMapper<MetaDTO, Meta> {
    ...
    @Mapping(target = "recursoNome", source = "recursoNome")
    ...
    @BeanMapping(ignoreByDefault = true)
    @Mapping(target = "id", source = "id")
    @Mapping(target = "politicaSGQ", source = "politicaSGQ")
    @Mapping(target = "desdobramentoSGQ", source = "desdobramentoSGQ")
    @Mapping(target = "objetivoSGQ", source = "objetivoSGQ")
