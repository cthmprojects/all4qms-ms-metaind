 ...
 */
@RestController
@RequestMapping("/api/indicador-metas")
public class IndicadorMetaResource {

    private static final Logger log = LoggerFactory.getLogger(IndicadorMetaResource.class);
    ...
    public ResponseEntity<IndicadorMetaDTO> createIndicadorMeta(@RequestBody IndicadorMetaDTO indicadorMetaDTO) throws URISyntaxException {
        ...
        indicadorMetaDTO = indicadorMetaService.save(indicadorMetaDTO);
        return ResponseEntity.created(new URI("/api/indicador-metas/" + indicadorMetaDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, indicadorMetaDTO.getId().toString()))
            .body(indicadorMetaDTO);
    }
    ...
    public ResponseEntity<IndicadorMetaDTO> updateIndicadorMeta(
        ...
        indicadorMetaDTO = indicadorMetaService.update(indicadorMetaDTO);
