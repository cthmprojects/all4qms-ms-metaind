 ...
 */
@RestController
@RequestMapping("/api/meta-objetivos")
public class MetaObjetivoResource {

    private static final Logger log = LoggerFactory.getLogger(MetaObjetivoResource.class);
    ...
    public ResponseEntity<MetaObjetivoDTO> createMetaObjetivo(@RequestBody MetaObjetivoDTO metaObjetivoDTO) throws URISyntaxException {
        ...
        metaObjetivoDTO = metaObjetivoService.save(metaObjetivoDTO);
        return ResponseEntity.created(new URI("/api/meta-objetivos/" + metaObjetivoDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, metaObjetivoDTO.getId().toString()))
            .body(metaObjetivoDTO);
    }
    ...
    public ResponseEntity<MetaObjetivoDTO> updateMetaObjetivo(
        ...
        metaObjetivoDTO = metaObjetivoService.update(metaObjetivoDTO);
