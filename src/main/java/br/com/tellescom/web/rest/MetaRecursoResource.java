 ...
 */
@RestController
@RequestMapping("/api/meta-recursos")
public class MetaRecursoResource {

    private static final Logger log = LoggerFactory.getLogger(MetaRecursoResource.class);
    ...
    public ResponseEntity<MetaRecursoDTO> createMetaRecurso(@RequestBody MetaRecursoDTO metaRecursoDTO) throws URISyntaxException {
        ...
        metaRecursoDTO = metaRecursoService.save(metaRecursoDTO);
        return ResponseEntity.created(new URI("/api/meta-recursos/" + metaRecursoDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, metaRecursoDTO.getId().toString()))
            .body(metaRecursoDTO);
    }
    ...
    public ResponseEntity<MetaRecursoDTO> updateMetaRecurso(
        ...
        metaRecursoDTO = metaRecursoService.update(metaRecursoDTO);
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<MetaRecursoDTO>> getAllMetaRecursos(
        MetaRecursoCriteria criteria,
