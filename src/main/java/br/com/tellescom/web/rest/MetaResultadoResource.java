 ...
 */
@RestController
@RequestMapping("/api/meta-resultados")
public class MetaResultadoResource {

    private static final Logger log = LoggerFactory.getLogger(MetaResultadoResource.class);
     ...
     */
    @PostMapping("")
    public ResponseEntity<MetaResultadoDTO> createMetaResultado(@Valid @RequestBody MetaResultadoDTO metaResultadoDTO)
        throws URISyntaxException {
        log.debug("REST request to save MetaResultado : {}", metaResultadoDTO);
        ...
        metaResultadoDTO = metaResultadoService.save(metaResultadoDTO);
        return ResponseEntity.created(new URI("/api/meta-resultados/" + metaResultadoDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, metaResultadoDTO.getId().toString()))
            .body(metaResultadoDTO);
    }
    ...
    public ResponseEntity<MetaResultadoDTO> updateMetaResultado(
        ...
        metaResultadoDTO = metaResultadoService.update(metaResultadoDTO);
