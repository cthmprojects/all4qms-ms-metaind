...
public class IndicadorCritica implements Serializable {
    ...
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "indicadorCritica")
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    @JsonIgnoreProperties(value = { "indicadorCritica" }, allowSetters = true)
    private Set<AcaoCritica> acaoCriticas = new HashSet<>();
    ...
    public Set<AcaoCritica> getAcaoCriticas() {
        return this.acaoCriticas;
    }

    public void setAcaoCriticas(Set<AcaoCritica> acaoCriticas) {
        if (this.acaoCriticas != null) {
            this.acaoCriticas.forEach(i -> i.setIndicadorCritica(null));
        }
        if (acaoCriticas != null) {
            acaoCriticas.forEach(i -> i.setIndicadorCritica(this));
        }
        this.acaoCriticas = acaoCriticas;
    }

    public IndicadorCritica acaoCriticas(Set<AcaoCritica> acaoCriticas) {
        this.setAcaoCriticas(acaoCriticas);
        return this;
    }

    public IndicadorCritica addAcaoCritica(AcaoCritica acaoCritica) {
        this.acaoCriticas.add(acaoCritica);
        acaoCritica.setIndicadorCritica(this);
        return this;
    }

    public IndicadorCritica removeAcaoCritica(AcaoCritica acaoCritica) {
        this.acaoCriticas.remove(acaoCritica);
        acaoCritica.setIndicadorCritica(null);
        return this;
    }
